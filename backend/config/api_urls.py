...
from apps.fees.api.views import CollectionViewSet, DistributionViewSet, SessionViewSet
from apps.users.api.views import ChangePasswordView, LoginView, LogoutView
